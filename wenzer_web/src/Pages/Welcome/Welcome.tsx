    ...
    <Container>
      <ContainerLogin id="home">
        <header>
          ...
          <h2>
            ...
            ganhar experiencias em projetos que poderá somar no seu portifólio!!{" "}
          </h2>
      ...
      <ContainerBusiness id="business">
        ...
        <div className="alignRight">
          ...
          <span>
            No wenzer, você pode participar de projetos remunerados, assim como
            também pode pagar alguém para participar de um projeto seu!
          </span>
          <a href="#home">
