...
const participantRepository_1 = require("../4-infra/repositories/participantRepository");
...
const projectService = new ProjectService_1.default(new projectRepository_1.ProjectRepository(), new followerRepository_1.FollowerRepository(), new interestRepository_1.InterestRepository(), new postRepository_1.PostRepository(), new participantRepository_1.ParticipantRepository());
